...
description: |
  ...
  Do not use for: general React/Next.js patterns (use z-nextjs, z-react-native skills).
  Workflow: Use alongside z-nextjs or z-react-native skill.
---
