...
> **Cloned & internalized** from [`vercel-labs/agent-skills` → `react-native-skills`](https://github.com/vercel-labs/agent-skills/tree/main/skills/react-native-skills) (MIT), with any Vercel-infrastructure-dependent content stripped for portability.
