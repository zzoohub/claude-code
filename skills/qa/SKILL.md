...
6. **Check TASKS.md** (if it exists) for known bugs or issues related to the changed files. If a task describes a bug that this branch should fix, add it to your test plan. If you find a new bug during QA that isn't in TASKS.md, note it in the report.
<!-- # LOCAL: Changed from TODOS.md to TASKS.md -->
...
### General SPA (React, Vue, Angular, SolidJS)
