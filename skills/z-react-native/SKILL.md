...
references:
  - references/examples.md    # Auth Guard, State Persistence, Forms, Animations code
---
...
→ Auth guard, state persistence, forms, and animation examples: `references/examples.md`
