...
Use when analyzing experiment results from PostHog (or any A/B testing tool). This covers the analysis methodology — experiment design and setup is handled by growth-optimizer / cro.
