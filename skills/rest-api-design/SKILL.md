...
description: |
  ...
  Do NOT use for: framework-specific implementation (use fastapi-hexagonal or axum-hexagonal after this).
  Workflow: requirements → this skill (OpenAPI spec) → fastapi-hexagonal | axum-hexagonal (implementation).
  Output: openapi/openapi.yaml at project root.
---

# rest-api-design — OpenAPI Spec Generator
