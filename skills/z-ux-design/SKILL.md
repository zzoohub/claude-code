...
description: |
  ...
  Do not use for: visual styling, color choices, component implementation (use z-design-system skill).
  Workflow: Often used before z-design-system (new features) or standalone (diagnosis, improvements).
references:
  - references/cognitive-principles.md   # Hick's Law, Fitts's Law, etc. with examples
  - references/design-process.md         # Step-by-step flow design guide
  - references/ergonomics.md             # Layout specs, touch targets, accessibility
---
...
For detailed explanations with examples → see `references/cognitive-principles.md`
...
- [ ] Mobile: primary actions in thumb zone (see `references/ergonomics.md`)
- [ ] Accessibility: not using color as only indicator

→ Step-by-step flow design process: `references/design-process.md`
→ Layout specs, touch targets, safe zones: `references/ergonomics.md`
